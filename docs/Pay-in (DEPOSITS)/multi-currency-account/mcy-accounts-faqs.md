...
### Are there any special considerations for third-party transactions?
 ...
 Yes, all third-party transactions are subject to further review to ensure compliance with regulatory and security standards. Recipients of third-party transactions may be required to provide additional information within 72 hours. If not provided, the transaction will be returned to the sender with a 15% return fee charged.
