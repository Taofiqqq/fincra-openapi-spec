---
title: Required Information/Documents (RFI)
excerpt: ''
deprecated: false
hidden: false
metadata:
...
next:
  description: ''
---
To ensure compliance with regulatory and security standards, recipients of third-party transactions and inflows exceeding the set threshold may be required to provide additional information. Below are the details of the required information and acceptable documents.
...
> ❗️ Failure to provide the required information within 72 hours of the transaction may result in the transaction being returned to the sender. A return fee of €5 for EUR transactions or $20 for USD transactions will be charged.
