...
next:
  description: ''
---
Our Direct Charge API allows you to charge local and international cards. This API is functional if the majority of your customers pay with credit or debit cards and you'd prefer they do so via your app.
...
This is a guide on how to charge a card. Please pay close attention. You would find test cards for use within our sandbox environment [here](docs/test-cards)
...
```json
{
  ...
  "card": {
    ...
    "card_holder": "The cardholder", // this is required for USD card payments
    "cvv": "419",
    "expiry_month": "12",
    "expiry_year": "32",
    "pin": "0000" // optional
...
The authorize charge endpoint can be found [here](/reference/authorize-a-charge).
