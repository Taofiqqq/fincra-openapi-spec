...
[block:parameters]
{
  "data": {
    ...
    "9-1": "Yes",
    "9-2": "string",
    "9-3": "The customer's place of birth",
    ...
    "16-0": "KYCInformation.address.number",
    "16-1": "Yes",
    "16-2": "string",
    "16-3": "The house number",
    ...
    "22-0": "KYCInformation.document",
    "22-1": "Yes",
    "22-2": "object",
    "22-3": "The document ",
    "23-0": "KYCInformation.document.type",
    "23-1": "Yes",
    "23-2": "string",
    "23-3": "The type of ID document e.g `passport`, `driverLicense`, `idCard`.  \n  \nPlease see the required values [here](/docs/documents-required-for-virtual-accounts-creation#individual-virtual-account)",
    "24-0": "KYCInformation.  \ndocument.number",
    "24-1": "Yes",
    "24-2": "string",
    "24-3": "The number on the document",
    "25-0": "KYCInformation.  \ndocument.issuedCountryCode",
    "25-1": "Yes",
    "25-2": "string",
    "25-3": "The country that issued the document.Should be in ISO 3166-1 alpha-2 – two-letter country codes format(NG)",
    "26-0": "KYCInformation.  \ndocument.issuedBy",
    "26-1": "Yes",
    "26-2": "string",
    "26-3": "The government agency in charge of issuing the document.",
    "27-0": "KYCInformation.  \ndocument.issuedDate",
    "27-1": "Yes",
    "27-2": "string",
    "27-3": "The date the document was issued(\"YYYY-mm-dd\")",
    "28-0": "KYCInformation.  \ndocument.expirationDate",
    "28-1": "Yes",
    "28-2": "string",
    "28-3": "The expiration date on the document (\"mm-dd-YYYY\").",
    "29-0": "KYCInformation.occupation",
    "29-1": "Yes",
    "29-2": "string",
    "29-3": "The occupation of the customer."
  },
  "cols": 4,
  "rows": 30,
  "align": [
