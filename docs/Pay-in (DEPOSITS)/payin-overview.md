...
| :------- | :------------------------------------------------- |
| NGN      | Card, Bank Transfer, Pay Attitude, Virtual Account |
| GHS      | Mobile Money                                       |
| KES      | Mobile Money                                       |
| UGX      | Mobile Money                                       |
| ZMW      | Card, Mobile Money                                 |
| TZS      | Mobile Money                                       |
| ZAR      | Card, EFT                                          |
| USD      | Card, Virtual Account                              |
| EUR      | Virtual Account                                    |
| XOF      | Mobile Money                                       |
| XAF      | Mobile Money                                       |
...
[Fincra’s virtual accounts](/docs/fincra-virtual-accounts) allow you or your customers to receive payments by bank transfers, with settlements in your balance. Fincra offers both temporary and permanent virtual accounts. Temporary virtual accounts are suitable for receiving one-time payments, while permanent virtual accounts are for consistent and regular payments.

![](https://files.readme.io/54de422-virtual_accounts.png "virtual_accounts.png")

### 3 - Payment Links

A [payment link](/docs/payment-links) is a simple way to collect payments from your customers by sending them links to pay you or accept donations. A payment link can easily be generated on your dashboard.

![](https://files.readme.io/971ee5f-Fincra-1.png "Fincra-1.png")

### 4 - Direct Charge API

Direct Charge becomes relevant when you require increased control or a customised solution compatible with your application. The Direct Charge API provides access to all checkout functionalities through API calls, enabling you to integrate your own user interface and workflow seamlessly. Please send an email to [us](mailto:compliance@fincra.com) to get access to this feature
