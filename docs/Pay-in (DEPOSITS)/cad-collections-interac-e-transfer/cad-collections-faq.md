---
title: CAD Collections FAQ
excerpt: Common questions about receiving CAD through Interac e-Transfer.
deprecated: false
hidden: false
metadata:
  robots: index
---
## What is CAD collection via Interac e-Transfer?

Interac e-Transfer is Canada's real-time payment network, used by virtually every Canadian bank. Fincra's CAD collection product lets you receive Canadian Dollars from Canadian payers directly into your Fincra CAD wallet using an Interac-enabled email address that we issue to you.

## Who can use CAD collections?

Both Individual and Corporate merchants registered on Fincra and approved through our CAD onboarding process.
...
1. Request a CAD collection account through the API or Merchant Portal.
2. Your Interac email (`merchantname@fincra.ca`) is generated and linked to your profile.
3. You receive a notification confirming you are ready to collect.
...
Payers send CAD only. Interac e-Transfer is a Canadian rail and only supports Canadian Dollars.

## Where does my collected CAD go?

Collected CAD is credited to your Fincra CAD wallet. It does not auto-convert to another currency on receipt. You decide when and how much to convert.
