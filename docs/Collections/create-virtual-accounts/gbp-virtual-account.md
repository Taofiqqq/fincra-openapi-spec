---
title: GBP (British Pound) Virtual Account
excerpt: ''
deprecated: false
hidden: false
metadata:
...
next:
  description: ''
---
This section describes the requirements for creating a virtual account in British Pound Sterling(GBP). In this section, the payloads have been separated into the requirements for individual and corporate accounts. Please take your time to go through each request properly.

With a GBP virtual account, payments can be received in British Pounds and made in different currencies.
...
[block:parameters]
{
  "data": {
    ...
    "0-1": "Yes",
    "0-2": "string",
    "0-3": "The virtual account currency.e.g GBP",
    "1-0": "accountType",
    "1-1": "Yes",
    "1-2": "string",
...
[block:parameters]
{
  "data": {
    ...
    "7-0": "KYCInformation.firstName",
    "7-1": "No",
    "7-2": "string",
    "7-3": "The customer's first name . This is required to create an individual  account",
    "8-0": "KYCInformation.lastName",
    "8-1": "No",
    "8-2": "string",
    "8-3": "The customer's last name . This is required to create an individual  account",
...
[block:parameters]
{
  "data": {
    ...
    "19-1": "yes",
    "19-2": "Object",
    "19-3": "The address of the country. This Should be in [alpha2code](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#Officially_assigned_code_elements)",
