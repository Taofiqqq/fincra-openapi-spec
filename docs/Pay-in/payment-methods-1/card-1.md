...
next:
  description: ''
---
One of the easiest ways for people to pay online is with a card. As a Fincra merchant, your customers can pay you from anywhere in the world with debit or credit cards. Fincra works well with most credit and debit card schemes,  allowing you to accept payments from your customers.

![](https://files.readme.io/8a62dcc-pay-with-cards-1.png "pay-with-cards-1.png")
