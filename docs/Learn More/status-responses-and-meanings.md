...
| **successful** | Transaction has been processed successfully                | Mark the transaction as successful                                                      |

Note: A transaction automatically reads as "expired" if it has been pending past two hours.

## List of status descriptions (Payout)

| Status         | Meaning                                                    | Recommended Action                                                                      |
| :------------- | :--------------------------------------------------------- | :-------------------------------------------------------------------------------------- |
| **processing** | Transaction is in progress and awaiting user authorization | You can re-query the associated endpoint to check if there has been a change in status. |
| **failed**     | Transaction failed and not processed                       | Mark the transaction as failed on your end                                              |
| **successful** | Transaction has been processed successfully                | Mark the transaction as successful                                                      |

## List of status descriptions (Checkout & Direct Charge)
...
| **successful** | Charge has been processed successfully                | Mark payment as successful                         |
