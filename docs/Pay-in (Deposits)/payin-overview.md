...
A  [POS terminal](/docs/pos-terminal-overview) is a hardware device used in retail outlets to handle card payments. Embedded in the technology is software that can read the magnetic stripes on credit and debit cards. Fincra's POS system allows your business to accept payments from customers and keep track of sales.

![](https://files.readme.io/b8f88fa-POS-terminal-.png "POS-terminal-.png")