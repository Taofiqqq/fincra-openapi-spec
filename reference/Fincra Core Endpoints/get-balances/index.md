...
> 📘 Note
>
> Please keep in mind that all payments made to a [business](/reference/business-1) via virtual bank accounts, checkout pages, or any Fincra API product will be stored in that business account balance.
...
![3257](https://files.readme.io/7082d41-balance_number.png "balance_number.png")
