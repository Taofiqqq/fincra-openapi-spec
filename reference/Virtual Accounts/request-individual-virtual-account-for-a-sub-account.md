---
title: Create individual virtual account for your sub-account
excerpt: >-
  This API lets you create a single individual virtual account for your
  sub-account
api:
  file: awesome-new-api.json
  operationId: request-individual-virtual-account-for-a-sub-account
deprecated: false
hidden: false
metadata:
  title: ''
