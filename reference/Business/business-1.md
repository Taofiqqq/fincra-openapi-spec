...
In order to  get your business ID, you will need to make an API cal to the [Get Business enpoint](/reference/get-business-id-1)

Get Sub account ID
------------------

In order to get the business ID of a subaccount you will need to follow the instructions [here](/reference/introduction-2)